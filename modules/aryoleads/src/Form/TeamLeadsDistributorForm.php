...
class TeamLeadsDistributorForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $option = ['DistributorId' => 'DistributorId', 'DistributorMobile' => 'DistributorMobile'];
    ...
    $selected_user = $form_state->getValue('user', 'DistributorId'); // Default to UserId if no value is set

    if ($selected_user === 'DistributorId') {
      $form['form_wrapper']['distributor_id'] = [
        '#type' => 'textfield',
        '#title' => $this->t('Distrbutor Id'),
        '#required' => TRUE,
      ];
    } elseif ($selected_user === 'DistributorMobile') {
      $form['form_wrapper']['distributor_mobile'] = [
        '#type' => 'textfield',
        '#title' => $this->t('Distrbutor Mobile'),
        '#required' => TRUE,
      ];
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) { 
    ...
    $distributor_mobile = $form_state->getValue('distributor_mobile');
    ...
    $url = 'http://localhost:8081/getAryoTeamsDistributorLeads';
