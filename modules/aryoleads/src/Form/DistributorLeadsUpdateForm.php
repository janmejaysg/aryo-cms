...
class DistributorLeadsUpdateForm extends FormBase {

    public function getFormId() {
        return 'dist_lead_update_form';
    }

    public function buildForm(array $form, FormStateInterface $form_state) {
        $form['heading'] = [
            '#type' => 'markup',
            '#markup' => '<h5>' . $this->t('Distributor Leads') . '</h5>',
          ];
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        if ($file) {
            ...
            $url = 'http://localhost:8081/updateDistributorLeads';
            ...
            try {
                ...
                // Display the message from the response to the user
